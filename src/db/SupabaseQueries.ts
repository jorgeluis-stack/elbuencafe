...
export const obtenerCuentasAbiertas = withFallback('obtenerCuentasAbiertas');
...
export const listarProductos = withFallback('listarProductos');
export const crearProducto = withFallback('crearProducto');
export const actualizarProducto = withFallback('actualizarProducto');
export const eliminarProducto = withFallback('eliminarProducto');
export const subirImagenProducto = withFallback('subirImagenProducto');
